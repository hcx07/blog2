...
?>
<!DOCTYPE html>
<!-- saved from url=(0023)http://game.163.com/767 -->
<html>
<head>
    ...
    <!--[if lt IE 9]>
    <?= Html::jsFile('@web/404/js/html5shiv.js') ?>
    <![endif]-->

    <?= Html::cssFile('@web/404/css/base.css') ?>
    <?= Html::cssFile('@web/404/css/index_c211cbd.css') ?>
    <style type="text/css">
        .adbase-ctn { background: url(@web/404/images/loading.png) center center no-repeat; }
    </style>
    <style type="text/css">
    ...
    <style type="text/css">
        ...
        .NIE-topBar-logo, .NIE-topBar-arrIcon i, #NIE-topBar-menu span, .NIE-topBar-hot, .NIE-topBar-1st, .NIE-topBar-new, .NIE-topBar-btn { background: url(@web/404/images/sprite-w_7fc7459.png) no-repeat }
        ...
        .NIE-topBar-logo { width: 133px; height: 44px; display: block; float: left; margin-top: 6px; background: url(@web/404/images/logo_b5525b7.png) no-repeat }
        ...
        #NIE-topBar-news-close { position: absolute; top: 63px; right: -380px; display: block; width: 32px; height: 32px; overflow: hidden; background: url(@web/404/images/sprite-w_7fc7459.png) no-repeat -9999px -9999px; text-indent: -9999px; z-index: 2 }
...
<div id="wrap">
    <div class="content">
        <div class="top">
            ...
            <a class="index-btn" href="https://blog.muniao.org"></a> </div>
...
<!-- JS放底部-->
<!-- jquery mix NIE (最新版本）-->
<?= Html::jsFile('@web/404/js/jquery(mixnie).last.js') ?>
<?= Html::jsFile('@web/404/js/script_5b27ce6.js') ?>
